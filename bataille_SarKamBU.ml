...
(* on crée les types couleur, valeur, carte et paquet *)
...
(* voici une fonction qui compare la valeur de deux cartes :
...
(* voici une fonction qui renvoie une chaîne de caractères
...
(* fonction permettant de mélanger aléatoirement un paquet de cartes *)
...
(* fonction permettant de partager un paquet de cartes en deux paquets distincts *)
...
(* fonction face à face qui renvoie le score selon les cartes utilisées pour l'affrontement *)
...
(* même fonction que celle de la question 7 mais avec du texte cette fois-ci *)
...
(* fonction bataille qui renvoie le score final à la fin de la partie *)
...
(* fonction qui prend en argument le nombre de parties et les exécute. Elle affiche aussi le nombre de victoires,
